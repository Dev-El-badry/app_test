...
class RolesController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($request->permission_selected) {
            $role->syncPermissions(explode(',', $request->permission_selected));
        }

        Session::flash('success', 'Successfull create the '.$role->display_name.' role in database');
    ...
    public function update(Request $request, $id)
    {
        ...
        Session::flash('success', 'Successfull update The New '.$role->display_name.' role in database');
